...
if __name__ == "__main__":
    ...
    matches_analysed, matches_bet_on, balance, avg_bet, avg_score_diff, standard_deviation, num_correct, num_incorrect, avg_odds_bet_win, avg_odds_bet_lose, weights_dict = match_analysis(0, 20, data)
    counter += 1
